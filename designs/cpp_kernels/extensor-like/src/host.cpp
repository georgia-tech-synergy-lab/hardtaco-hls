...
int main(int argc, char** argv) {
	...
	if (MATRIX_SIZE_M > STORAGE_M_DIM || MATRIX_SIZE_K > STORAGE_K_DIM || MATRIX_SIZE_N > STORAGE_N_DIM || MK_NNZ > STORAGE_MK_NNZ || KN_NNZ > STORAGE_KN_NNZ) {
	...
	size_t kn_ptr_size = MATRIX_SIZE_N + 1;
